    ...
    while count > 0:
        ...
        for i in range(n - 2):
            for j in range(i + 2, n - (i == 0)):
                ...
                p2 = G.get_edge_data(route[j], route[j + 1])["weight"]
                p3 = G.get_edge_data(route[i], route[j])["weight"]
                p4 = G.get_edge_data(route[i + 1], route[j + 1])["weight"]
        ...
        for i in range(n - 4):
            for j in range(i + 2, n - 2):
                for k in range(j + 2, n - (i == 0)):
                    d1 = G.get_edge_data(route[i], route[i + 1])["weight"] + G.get_edge_data(route[j], route[j + 1])["weight"] + G.get_edge_data(route[k], route[k + 1])["weight"]
                    d2 = G.get_edge_data(route[i], route[j])["weight"] + G.get_edge_data(route[i + 1], route[j + 1])["weight"] + G.get_edge_data(route[k], route[k + 1])["weight"]
                    d3 = G.get_edge_data(route[i], route[i + 1])["weight"] + G.get_edge_data(route[j], route[k])["weight"] + G.get_edge_data(route[j + 1], route[k + 1])["weight"]
                    d4 = G.get_edge_data(route[i], route[k])["weight"] + G.get_edge_data(route[j], route[j + 1])["weight"] + G.get_edge_data(route[i + 1], route[k + 1])["weight"]
                    d5 = G.get_edge_data(route[i], route[j + 1])["weight"] + G.get_edge_data(route[i + 1], route[k])["weight"] + G.get_edge_data(route[j], route[k + 1])["weight"]
